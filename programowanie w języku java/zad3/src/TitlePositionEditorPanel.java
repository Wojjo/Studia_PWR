...
public class TitlePositionEditorPanel extends JPanel {

	private static final long serialVersionUID = 1L;

	public TitlePositionEditorPanel(PropertyEditorSupport ed) {
		editor = ed;
		...
		elementList.setModel((DoubleArrayListModel2) model);
	...
	private DoubleArrayListModel2 model = new DoubleArrayListModel2();
}


class DoubleArrayListModel2 extends AbstractListModel<Integer> {
